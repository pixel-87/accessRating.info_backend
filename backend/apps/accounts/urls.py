...
urlpatterns = [
    ...
    path('favorites/toggle/<int:business_id>/', views.toggle_favorite, name='toggle-favorite'),
    
    # Search history
    path('search-history/', views.UserSearchHistoryView.as_view(), name='user-search-history'),
]
