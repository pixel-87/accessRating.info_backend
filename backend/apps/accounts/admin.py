...
class UserProfileInline(admin.StackedInline):
    ...
    fields = [
        ...
        'assessor_certification_date', 'email_notifications', 'profile_public'
    ]
...
class UserProfileAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'user', 'user_type', 'phone', 'assessor_training_completed',
...
class UserSearchHistoryAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'user', 'search_query', 'search_location',
        'business_type_filter', 'accessibility_filter', 'created_at'
    ]
