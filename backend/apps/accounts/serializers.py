...
from .models import UserProfile, UserFavorite, UserSearchHistory
...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserProfile
        fields = [
            'user_type', 'phone', 'bio', 'accessibility_needs',
            'business_license_number', 'assessor_training_completed',
            'assessor_certification_date', 'email_notifications',
            'profile_public', 'created_at', 'updated_at'
        ]
...
class UserFavoriteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserFavorite
        fields = [
            'id', 'business', 'business_name', 'business_accessibility_level',
            'business_city', 'business_type', 'created_at'
        ]
...
class UserSearchHistorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'search_query', 'search_location', 'business_type_filter',
            'accessibility_filter', 'created_at'
        ]
        read_only_fields = ['id', 'created_at']
